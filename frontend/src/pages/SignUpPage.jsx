...
const SignUpPage = () => {  
  ...
  const validateForm = () =>{
    if(!formData.fullName.trim()) return toast.error("Full name is reqired");
        if(!formData.email.trim()) return toast.error("Email is reqired");
    ...
    <div className='min-h-screen grid lg:grid-cols-2'>
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button type='submit' className='btn-primary w-full bg-gray-300 p-2 rounded' disabled= {isSigningUp}>
            {isSigningUp ? (
              <>
      ...
      {/* Right side */}
            ...
            <AuthImagePattern       
              ...
              subtitle = "Connect with fiends, share moments, and stay in touch with your loved ones."
            />
